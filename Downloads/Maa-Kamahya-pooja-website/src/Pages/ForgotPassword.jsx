      ...
      <div className="container p-5">
        <div className="row d-flex justify-content-start align-items-center login-container">
          <div className="col-lg-5 col-10">
            <div id="circle"></div>
            <div className="pb-5">
              <img src="" alt="" className="login-image mt-5" />
            </div>
          </div>
            ...
            <div className="mt-1 mt-md-5">
              ...
              <form className="pt-4">
                <div className="d-flex flex-column pb-3">
                  ...
                  <input type="email" name="email" id="emailId" placeholder="Enter your Email Address" className="login-input"/>
                </div>
                ...
                <div className="register mt-5">
                  <p> Don't have an account?
                    <NavLink to="/register" className="register-account"> Create an account </NavLink>
                  </p>
                </div>
              </form>
            </div>
