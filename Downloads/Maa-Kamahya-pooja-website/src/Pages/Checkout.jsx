...
import checkoutimg from "../assets/Checkoutimg.jfif";
...
const Checkout = () => {
  ...
  const SaveShippingHandler = async (e) => {
    ...
    // Transform cartItems to the desired format
    ...
    // Combine shipping info and orders into checkoutData
    const checkoutData = {
        orders,
        totalPrice,
        ...
        phoneNumber: shippingData.phoneNo,
    };

    console.log("Final Checkout Data:", checkoutData);

    try {
        const response = await axios.post(`${baseUrl}/admin-orders`, checkoutData, {
        ...
        <div className="row d-flex justify-content-start align-items-center ">
          ...
          {/* <div className="col-lg-5 col-10">
            <div className="pb-5 mt-5">
              <img src={checkoutimg || "../assets/Checkoutimg.jfif"} alt="Shipping Details" title="Shipping Details" className="login-image" />
            </div>
          </div> */}
